...
//
//public class WebConfigWithXmlSpring implements WebApplicationInitializer {
...
//		rootContext.setConfigLocation("/WEB-INF/beans-config.xml");
...
//		dispatcherServlet.setConfigLocation("/WEB-INF/dispatcher-servlet.xml");
//		// Register and map the dispatcher servlet
//		ServletRegistration.Dynamic dispatcher = container.addServlet("dispatcher",
//				new DispatcherServlet(dispatcherServlet));
//		dispatcher.setMultipartConfig(getMultipartConfigElement());
//		dispatcher.setLoadOnStartup(1);
//		dispatcher.addMapping("/com/*");
//
//	}
//
